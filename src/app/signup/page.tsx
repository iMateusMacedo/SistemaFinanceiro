      ...
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-4xl w-full bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:flex flex-col justify-center p-12 bg-gradient-to-br from-emerald-500 to-cyan-600">
          <div className="flex items-center mb-4">
            <h1 className="text-4xl lg:text-5xl font-bold text-white">Bem-vindo a <span className="rainbow-text">MG Wallet</span></h1>
          </div>
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="md:hidden text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold rainbow-text">MG Wallet</h1>
          </div>

          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-500">
            Cadastro
          </h2>
